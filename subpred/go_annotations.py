...
def __get_go_subgraph(
    graph_go, root_node:str="GO:0022857", keys:set={"is_a"}, namespaces:set={"molecular_function"}
):
...
def get_go_annotations_subset(
    ...
    Args:
        ...
        annotations_evidence_codes_remove (set, optional): 
            Filter out evidence codes, most commonly IEA. Defaults to None.
